...
.. plot::
   ...
   fig = plt.figure()
   features.FallingCurve(mes[0]).plot(figure=fig)
...
.. plot::
   ...
   fig = plt.figure()
   features.FallingCurve(mes[2]).plot(figure=fig)
...
.. plot::
   ...
   fig = plt.figure()
   features.FallingCurve(mes[3]).plot(figure=fig)
...
.. plot::
   ...
   fig = plt.figure()
   features.FallingCurve(mes[4]).plot(figure=fig)
